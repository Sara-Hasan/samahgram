                    ...
                    <form action="{{ route('profile', $user->id) }}" method="post" enctype="multipart/form-data">
                        <div class="grid grid-cols-2 gap-3 lg:p-6 p-4">
                            <div class="form-group">
                                ...
                                <img width="100" height="100" src="{{ $user->user_img }}" alt="{{ $user->name }}"
                                    style=" margin-bottom:
                                20px;">
                                <label for="pwd">Change user Image</label>

                                <input type="file" class="form-control-file" id="pwd" placeholder="Enter password"
                                    name="user_img">
                            </div>
                            <div class="col-span-2">
                                <label for=""> User name</label>
                                <input type="text" name="name" placeholder="Your name.." class="shadow-none bg-gray-100"
                                    value="{{ $user->name }}">
                            </div>
