                ...
                <section class="div_set zw3Ow ">
                    ...
                    <section class="div_set wW3k-">
                            ...
                            <div class=" div_set   qF0y9   Igw0E    IwRSH  eGOV_  ybXk5   ui_ht bPdm3">
                                <div class=" div_set  qF0y9    Igw0E    IwRSH      eGOV_  vwCYk  ">
                                    ...
                                    <form action="{{route('follows.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="submit" class="_5f5mN  jIbKX  _6VtSN yZn4P" name="follow" value="Follow">
                                    </form>
                                    ...
                                    <form action="{{route('follows.destroy',$results[0]->id)}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('DELETE')
                                        <input type="submit" class="_5f5mN  jIbKX  _6VtSN yZn4P" name="follow" value="Un Follow">
                                    </form>
                        ...
                        <ul class="k9GMp ">
                            ...
                            <li class="Y8-fY "><span class="-nal3 " tabindex="0"><span class="g47SY ">@if(!empty($user_followers)) {{count($user_followers)}} @else<span>0</span> @endif</span> followers</span></li>
                            <li class="Y8-fY "><span class="-nal3 " tabindex="0"><span class="g47SY ">@if(!empty($user_following)) {{count($user_following)}} @else <span>0</span> @endif</span> following</س>
                            </li>
                        </ul>
                                ...
                                <div class="div_set _97aPb   wKWK0">
                                    <div role="button" class="ZyFrc" tabindex="0">
                                        <div class="div_set eLAPa kPFhm">
                                            <div class="div_set KL4Bh" style="padding-bottom: 100%;"><img alt="{{ $value->post_text }}" class="FFVAD" crossorigin="anonymous" decoding="auto" style="object-fit: cover;" sizes="598px" src="{{ $value->post_img }}">
                                            </div>
                                ...
                                <div class="div_set  qF0y9 Igw0E  IwRSH   eGOV_ _4EzTm ">
                                    <div class="div_set cv3IO  ">
                                                ...
                                                <section class="div_set  Ppjfr">
                                                    <div class="div_set Jv7Aj mArmR   pZp3x">
                                                        <div class="div_set RR-M- h5uC0 mrq0Z" aria-disabled="false" role="button" tabindex="0">
                                                            ...
                                                            <span class="_2dbep " role="link" tabindex="-1" style="width: 32px; height: 32px;"><img alt="{{ $value->user->name }}" class="_6q-tv" crossorigin="anonymous" data-testid="user-avatar" draggable="false" src="{{ $value->user->user_img }}"></span>
                                                        </div>
                                                    </div>
                                                    <div class="div_set o-MQd z8cbW ">
                                                        <div class="div_set PQo_0 RqtMr">
                                                            <div class="div_set e1e1d">
                                                                <span class="Jv7Aj mArmR MqpiF  "><a class="sqdOP yWX7d     _8A5w5   ZIAjV " href="/profile/{{ $value->user->id }}" tabindex="0">{{ $value->user->name }}</a></span>
                                                            ...
                                                            <div class="div_set bY2yH">
                                                                ...
                                                                <form action="{{ route('posts.destroy', $value->id) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button class="sqdOP yWX7d  _8A5w5 delet" type="submit">Delete
                                                                    </button>
                                                                </form>
                                                                @else
                                        ...
                                        <div class="div_set eo2As  ">
                                                            ...
                                                            <div class="div_set P9YgZ">
                                                                <div class="div_set C7I1f X7jCj">
                                                                    ...
                                                                    <div class=" div_set C4VMK ">
                                                                        ...
                                                                        <span class="">{{ $value->post_text }}</span>
                                                                        <div class="    qF0y9 Igw0E     IwRSH      eGOV__4EzTm   pjcA_   aGBdT     ">
                                                                            <div class="_7UhW9  PIoXz       MMzan   _0PwGvuL8Hv">
                                                                                <time class="FH9sR RhOlS Nzb55" datetime="{{ $value->created_at->diffForHumans() }}" title="{{ $value->created_at->diffForHumans() }}">
                                                                    ...
                                                                    <div class="div_set C7I1f ">
                                                                        <div class="div_set Jv7Aj mArmR   pZp3x">
                                                                            <div class="div_set RR-M-  TKzGu  " aria-disabled="true" role="button" tabindex="-1">
                                                                                <canvas class="CfWVH" height="42" width="42" style="position: absolute; top: -5px; left: -5px; width: 42px; height: 42px;"></canvas>
                                                                                <a class="_2dbep qNELH kIKUG" href="/profile/{{ $comment->user_id }}" tabindex="0" style="width: 32px; height: 32px; display: block;"><img alt="{{ $comment->user->name }} profile picture" class="_6q-tv" crossorigin="anonymous" data-testid="user-avatar" draggable="false" src="{{ $comment->user->user_img }}"></a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="div_set C4VMK">
                                                                            <h3 class="_6lAjh ">
                                                                                <div class="    qF0y9 Igw0E     IwRSH      eGOV__4EzTm   ItkAi        ">
                                                                                    <span class="Jv7Aj mArmR MqpiF  "><a class="sqdOP yWX7d     _8A5w5   ZIAjV " href="/profile/{{ $comment->user_id }}" tabindex="0">{{ $comment->user->name }}</a></span>
                                                                                </div>
                                                                            </h3>
                                                                            ...
                                                                            <div class=" div_set   qF0y9 Igw0E     IwRSH      eGOV__4EzTm   pjcA_   aGBdT     ">
                                                                                <div class="div_set flex-row _7UhW9  PIoXz       MMzan   _0PwGvuL8Hv">
                                                                                    <span class="gU-I7" tabindex="0"><time class="FH9sR RhOlS Nzb55" datetime="{{ $comment->created_at->diffForHumans() }}" title="{{ $comment->created_at->diffForHumans() }}">{{ $comment->created_at->diffForHumans() }}</time></span>
                                            ...
                                            <div class="div_set k_Q0X I0_K8  NnvRN"><span class="c-Yi7" tabindex="0"><time class="_1o9PC Nzb55" datetime="{{ $value->created_at->diffForHumans() }}" title="{{ $value->created_at->diffForHumans() }}">{{ $value->created_at->diffForHumans() }}</time></span>
                                            </div>
                                            <section class="sH9wk  _JgwE ">
                                                <div class="div_set RxpZH">
                                                    ...
                                                    <form class="X7cDz" action="/comments" method="POST">
                                                        ...
                                                        <textarea id="comment_text" name="comment_text" aria-label="Add a comment…" data-testid="post-comment-text-area" placeholder="Add a comment…" class="Ypffh" autocomplete="off" autocorrect="off" style="height: 18px !important;"></textarea>

                                                        <button class="sqdOP yWX7d  y3zKF " data-testid="post-comment-input-button" type="submit">Post</button>
                                                    </form>
                                                </div>
                                            </section>
                                        </div>
