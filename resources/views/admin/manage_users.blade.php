...
if (isset($_GET['delete'])) {
  ...
  redirect("manage_users.blade.php");
}
// add and edit
if (isset($_GET['do'])) {
  $do = $_GET["do"];
          ...
          <div class="users-table table-wrapper">
            <table class="table table-striped" id="table1">
              ...
              <button class="btn btn-primary" style="float: right;margin:10px 50px 0px 10px;">
                <a href="manage_users.blade.php?do=add">Add user </a>
              </button>
              <thead>
                    ...
                    <td>
                      <div class="table-data-feature">
                        <button class="btn btn-success" title="edit">
                          <a href="manage_users.blade.php?do=edit&id=<?php echo $user['user_id'] ?>"> edit </a>
                        </button>
                        <button class="btn btn-danger" title="delete">
                          <a href="manage_users.blade.php?delete=<?php echo $user['user_id'] ?>"> delete </a>
                        </button>
                      </div>
                    </td>
                  </tr>
