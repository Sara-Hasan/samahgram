...
if (isset($_GET['delete'])) {
  ...
  redirect("manage_admins.blade.php");
}
          ...
          <div class="users-table table-wrapper">
            <table class="table table-striped" id="table1">
              <button class="btn btn-primary" style="float: right;margin:10px 50px 0px 10px;">
                <a href="manage_admins.blade.php?do=add">Add Admin </a>
              </button>
              <thead>
                    ...
                    <td>
                      <div class="table-data-feature">
                        <button class="btn btn-success" title="edit">
                          <a href="manage_admins.blade.php?do=edit&id=<?php echo $admin['admin_id'] ?>"> Edit </a>
                        </button>
                        <button class="btn btn-danger" title="delete">
                          <a href="manage_admins.blade.php?delete=<?php echo $admin['admin_id'] ?>"> Delete </a>
                        </button>
                      </div>
                    </td>
                  </tr>
