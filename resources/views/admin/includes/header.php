        ...
        <div class="sidebar-body">
          <ul class="sidebar-body-menu">
            ...
            if (isset($_SESSION["type"])) {
              if ($_SESSION["type"] == 2) {
                echo '<li>
                                  <a href="manage_admins.blade.php"><span class="icon document" aria-hidden="true"></span>Admin</a>
                                </li>
                                <li>
                                  <a href="manage_users.blade.php"><span class="icon document" aria-hidden="true"></span>Users</a>
                                </li>';
              }
            }
            ?>
            ...
            <li>
              <a href="../index.blade.php"><span class="icon paper" aria-hidden="true"></span>webisite</a>
            </li>
            </li>
          </ul>
          <?php
