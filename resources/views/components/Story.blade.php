    ...
    <div class="uk-modal-dialog story-modal">
        ...
        <div class="flex-1 bg-white dark:bg-gray-900 dark:text-gray-100">
            ...
            <div class="story-content p-4" data-simplebar>
                ...
                <div class="py-4 ">
                    <div class="flex ">
                        <button name="like" class="flex items-center space-x-3 pr-2">
                            <div class="flex font-bold items-baseline">
                                <svg aria-label="Like" class="_8-yf5 comment " color="#000" fill="#000" height="24"
                            ...
                            <label for="comment" class="comment_lable">
                                <svg aria-label="Comment" class="_8-yf5 comment" color="#000" fill="#000" height="24"
                                    role="img" viewBox="0 0 24 24" width="24">
