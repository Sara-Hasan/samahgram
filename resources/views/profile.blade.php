                        ...
                        <div class="flex flex-1 items-center space-x-4">
                           <a href="#">
                              <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-0.5 rounded-full">
                                 <img src={{$value->user->user_img}}  class="bg-gray-200 border border-white rounded-full w-8 h-8">
                              </div>
                           </a>
                           <span class="block text-lg font-semibold"> {{$value->user->name}} </span>
                        </div>
                     </div>
            ...
            <div class="div_set _1XyCr  ">
               ...
               <div class="div_set isgrP">
                  <ul class="jSC57  _6xe7A">
                     ...
                     @foreach($follower_id as $follower)
                        <li class="wo9IH">
                              ...
                              <div class="div_set t2ksc">
                                 <div class="div_set Jv7Aj mArmR   pZp3x">
                                    <div class="div_set RR-M-  SAvC5" aria-disabled="true" role="button" tabindex="-1">
                                       ...
                                       <a class="_2dbep qNELH kIKUG" href="/ahmad_150.ok/" tabindex="0" style="width: 30px; height: 30px; display: block;"><img alt="ahmad_150.ok's profile picture" class="_6q-tv" crossorigin="anonymous" data-testid="user-avatar" draggable="false" src="{{$follower->user_img}}"></a>
                                    </div>
                                 </div>
                                 <div class="div_set enpQJ">
                                    <div class="div_set d7ByH">
                                       <span class="Jv7Aj mArmR MqpiF  "><a class="FPmhX notranslate  _0imsa " title="ahmad_150.ok" href="{{route('profile',$following->id)}}" tabindex="0">{{$follower->name}}</a></span>
                                    ...
                                    <div class="div_set wFPL8 "><a href="{{route('profile',$following->id)}}">{{$follower->name}}</a></div>
                                 </div>
                              </div>
                           ...
                           <div class="div_set uu6c_">
                              <div class="div_set t2ksc">
                                 <div class="div_set Jv7Aj mArmR   pZp3x">
                                    <div class="div_set RR-M-  SAvC5" aria-disabled="true" role="button" tabindex="-1">
                                       <canvas class="CfWVH" height="40" width="40" style="position: absolute; top: -5px; left: -5px; width: 40px; height: 40px;"></canvas>
                                       <a class="_2dbep qNELH kIKUG" href="/ahmad_150.ok/" tabindex="0" style="width: 30px; height: 30px; display: block;"><img alt="ahmad_150.ok's profile picture" class="_6q-tv" crossorigin="anonymous" data-testid="user-avatar" draggable="false" src="{{$following->user_img}}"></a>
                                    </div>
                                 </div>
                                 <div class="div_set enpQJ">
                                    <div class="div_set d7ByH">
