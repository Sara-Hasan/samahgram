                ...
                <div class="relative" uk-slider="finite: true">
                    ...
                    <div class="uk-slider-container pb-3 -ml-3">
                            ...
                            @foreach($follows as $follower)
                                ...
                                @if($follower->second_user_id == $signedUser)
                                    @php 
                                        array_push($userFollowers,$follower->user_id);
                                    @endphp
                                @endif
                            @endforeach
                            ...
                            <?php
                            if(!in_array($user->id,$userFollowers) && $user->id != $signedUser){

                            ?>
                                {{-- @if($follower->user_id != $userFollowers ) --}}
                                <li>
